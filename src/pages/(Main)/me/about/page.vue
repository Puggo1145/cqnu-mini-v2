...
<template>
    ...
    >
        <scroll-view
            ...
            class="flex-1 w-full"
        >
            <view class="mt-8 flex items-center gap-x-4">
                <image
                    :src="logo"
                ...
                <view class="flex flex-col">
                    ...
                    <text class="text-sm text-secondary-foreground">v2.1.8</text>
                </view>
            </view>
            <view class="mt-9">
                <title-desc
                    title="开发者团队"
                    desc="小程序的核心开发团队由来自不同学院、不同专业、不同年级以及各有所长的同学组成"
                    title-size="medium"
                />
